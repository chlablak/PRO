...
\begin{document}
	...
	\section{Cadre de développement} 
		L'application est développée à l'aide du langage C++ (standard 2011) et de la bibliothèque Qt (version 5.5.1). Elle est compilée avec MinGW 4.9.2 32 bits sur Windows. La version de la librairie Boost utilisée pour le parseur est la 1.60.0. Afin que le code source soit écrit dans le même style par tous les membres du groupe, nous avons décidé d'utiliser le Coding Style de Qt \cite{qtStyle} qui correspond bien à nos besoins.
	...
	\section{Interpréteur} % Champion
		...
		\label{subsec:egli-exemple}
			\textcolor{red}{faire un exemple d'utilisation classique, et une section sur les tests}
		...
		\subsection{Fonctions incluses}
			...
			\begin{figure}[H]
				...
				\begin{longtable}{p{0.45\textwidth}p{0.45\textwidth}p{0.1\textwidth}}
					...
					\texttt{String type(T a)} & Retourne le type de \texttt{a} sous forme de chaîne & \textit{built-in}\\
			...
			\textcolor{red}{mettre à jour, voir avec alain si il a ajouter une autre "GUI"}
