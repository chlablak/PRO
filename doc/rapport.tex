...
\begin{document}
	...
	\section{Interpréteur} % Champion
		...
		\subsection{Architecture}
			...
			\begin{figure}[H]
				\centering
				\begin{tikzpicture}
					\draw (0,0) node[anchor=north] {interpretor \#1} rectangle (3,3);
					\draw[fill=black] (1,1) node[anchor=north] {datas} rectangle (2,2);
					
					\draw (5,0) node[anchor=north] {interpretor \#2} rectangle (8,3);
			...
			\begin{figure}[H]
				\centering
				\begin{tikzpicture}
					\draw (0,0) node[anchor=north] {interpretor} rectangle (3,3);
	...
	\begin{thebibliography}{9}
		...
		\url{https://en.wikipedia.org/wiki/Adjacency_matrix#Data_structures}
	\end{thebibliography}			
