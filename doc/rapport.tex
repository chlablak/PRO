...
\begin{document}
	...
	\section{Annexes projet}
		\includepdf[pages=-]{cahierdescharges}
		\includepdf[pages=-]{journaldetravail}
		\includepdf[pages=-]{guideinstallation}
		\includepdf[pages=-]{guideutilisation}
		% TODO planification et evolution		
