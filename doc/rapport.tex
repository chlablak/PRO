...
\begin{document}
	...
	% Titre du document
	\title{GraphY} % ou un autre nom\centering
	\author{Rapport\\ 
		Projet de semestre\\
			...
			\label{subsubsec:analyse-des-types-et-des-operations}
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item Les valeurs par défaut sont \texttt{label[String]="", weight[Number]=0, }\\
						\texttt{max\_capacity[Number]=min\_capacity, min\_capacity[Number]=0}
					\end{itemize}
					\item \texttt{Edge}: 
					\begin{itemize}
						...
						\item Les valeurs par défaut sont \texttt{weight[Number]=0, label[String]="", }\\
						\texttt{max\_capacity[Number]=min\_capacity, min\_capacity[Number]=0}
