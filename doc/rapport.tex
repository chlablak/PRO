	...
	\section{Interpréteur} % Champion
		...
		\subsection{Règles de transformation}
			...
			\begin{figure}[H]
				...
				\end{tabular}
				\caption{Exemples de transformations}
			\end{figure}
			...
			\centering
			\texttt{Graph pcc=dijkstra(\{v0,1:Yverdon,e01,2,0->2:9,1<-2:3\},v0)} (avec \texttt{v0=(0)} et \texttt{e01=(0->1)})
			\justify
			...
			\begin{figure}[H]
				...
				\begin{tabular}{cccc}
					...
					\hline
					D & Déclaration & Nom de la variable & 1\\
			...
			\subsubsection{Arbre d'appels des traitements}
				...
				Maintenant que nous avons un arbre d'appels hiérarchique des traitements, reste à savoir comment nous allons l'utiliser. Le principe est très simple: 
