	...
	\section{Interpréteur} % Champion
		...
		\subsection{Mémoire virtuelle} 
			...
			\subsubsection{Number, Edge et Vertex}
				...
				Le soucis avec cette approche est que les attributs optionnels sont construits même s'il ne sont pas utilisés, par ailleurs sur mon ordinateur \texttt{sizeof(Vertex) == 36}. Cela implique une utilisation inutile en ressources pour des attributs qui ne seront pas forcément utilisés.\\
				...
				Nos types "simples" sont maintenant définit, notons que les exemples d'implémentation ci-dessous ne sont pas complets, mais ils montrent clairement l'approche générale.
