	...
	\section{Interpréteur} % Champion
		...
		\subsection{Règles de transformation}
			...
			\subsubsection{Arbre d'appels des traitements}
				...
				On voit que cette approche récursive nous permet de bien arriver au résultat escompté, et ce, depuis un traitement qui à la base était très complexe avant sa transformation.
