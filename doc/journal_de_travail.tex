...
\begin{document}
	...
	\begin{tabular}{p{0.11\textwidth}|p{0.07\textwidth}|p{0.3\textwidth}|p{0.4\textwidth}}
		...
		23.04.2016 & 1.5 & Préparation présentation & \\
	\end{tabular}
	...
	\begin{tabular}{p{0.11\textwidth}|p{0.07\textwidth}|p{0.3\textwidth}|p{0.4\textwidth}}
		...
		19.04.2016 & 1.0 & Conception de l'interpréteur & Fin de l'architecture, diagramme de classes\\ 
		20.04.2016 & 2.0 & Implémentation & Début du parseur\\
		21.04.2016 & 0.5 & Implémentation & Grammaire en cours\\
		...
		24.04.2016 & 1.0 & Implémentation & Grammaire ok mais améliorable, édition du rapport\\ 
		\hline
	\end{tabular}
