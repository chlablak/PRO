...
QT_MOC_LITERAL(1, 11, 22), // "searchResultsRequested"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 10), // "searchWord"
QT_MOC_LITERAL(4, 46, 11) // "searchAsked"

    },
    "HelpWindow\0searchResultsRequested\0\0"
    "searchWord\0searchAsked"
};
...
void HelpWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->searchResultsRequested((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->searchAsked(); break;
        default: ;
        }
        ...
        {
            typedef void (HelpWindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HelpWindow::searchResultsRequested)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject HelpWindow::staticMetaObject = {
    { &QVBoxLayout::staticMetaObject, qt_meta_stringdata_HelpWindow.data,
...
// SIGNAL 0
void HelpWindow::searchResultsRequested(QString _t1)
{
